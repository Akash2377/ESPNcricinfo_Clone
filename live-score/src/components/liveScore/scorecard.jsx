...
export const ScoreCard=()=>{
  ...
  <Table size='sm'>
    ...
    <br />
    <h3>2-1 (Martin Guptill, 0.5), 14-2 (Devon Conway, 8.2), 14-3 (Tom Latham, 8.5), 33-4 (Kane Williamson, 18.1), 38-5 (Daryl Mitchell, 20.5), 45-6 (James Neesham, 21.6),</h3>
    <h3>54-7 (Michael Bracewell, 25.1), 57-8 (Tim Southee, 26.4), 72-9 (Matt Henry, 30.1), 82-10 (Trent Boult, 32.6)</h3>
    <br />
  <Table size='sm'>
    <Thead>
      <Tr>
